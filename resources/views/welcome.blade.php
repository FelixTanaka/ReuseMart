...
<head>
  ...
  <title>Reuse Mart - E-Commerce Style</title>
...
<body>
  ...
  <nav class="navbar navbar-expand-lg sticky-top">
    <div class="container">
      ...
      <div class="d-flex">
        <a href="{{ route('login') }}" class="btn btn-warning me-2 text-dark fw-semibold" style="border-radius: 20px;">Masuk</a>
        <a href="{{ route('register.form') }}" class="btn btn-light text-success fw-semibold" style="border-radius: 20px; border: 1px solid #ccc;">Daftar</a>
      </div>
    </div>
  </nav>
  ...
  <section class="hero-section">
    <div class="container">
      ...
      <p>Reuse Mart - Hemat, Ramah Lingkungan, dan Bermanfaat</p>
      <a href="#produk" class="btn btn-primary-custom">Belanja Sekarang</a>
    </div>
  </section>
